        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <form class="row" method="post" action="/update_book/{{$book->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                ...
                                <textarea class="form-control" id="exampleTextarea" rows="3" name="synopsis" >{{$book->synopsis}}</textarea>
                            </div>
                            <br>
                            <div>
                            ...
                            <div>
                                ...
                                <input class="form-control" type="text" name="lease_week" value="{{$book->lease_week}}">
                            </div>
                            <br>
                            <div>
                            ...
                            <div>
                                ...
                                <input class="form-control" type="text" name="quantity" value="{{$book->quantity}}">
                            </div>
                            <br>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="exampleInputAmount" name="price" type="text" placeholder="Amount" value="{{$book->price}}" >
                            ...
                            <div>
                                ...
                                <p class="text-center"><small>Please leave blank if image isn't going to be updated</small></p>
                            </div>

                            <input type="hidden" value="{{$book->images}}" name="firstImage">
                            <br>
                            <img src="{{asset('storage/'.$book->images)}}" alt="" height="220" style="border-radius: 10px">
                            <div class="tile-footer">
                                <button class="btn btn-primary col-md-12" type="submit" name="add_book">Update Book</button>
                            </div>
