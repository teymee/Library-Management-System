...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> Decline Request </h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <form class="row" method="post" action="/decline_request/{{$request->id}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control"  name="reason" type="text"
                                              style="@error('reason') border-color:red; @enderror"></textarea>
                                    @error('reason')
